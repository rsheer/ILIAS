...
{		
	...
	public static function isUploadPossible($a_additional_size = null)
	{
		...
		include_once "Services/WebDAV/classes/diskquota/class.ilDiskQuotaActivationChecker.php";			
		...
		include_once "Services/WebDAV/classes/diskquota/class.ilDiskQuotaChecker.php";	
